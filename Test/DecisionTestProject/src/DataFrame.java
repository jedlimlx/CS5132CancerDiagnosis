...
public class DataFrame {
    ...
    public DataFrame(String csvName, int attributeCount, int sampleCount) throws FileNotFoundException {
    ...
    public HashMap<String, Integer> getLabelToColumnHashMap() {
        return labelToColumnHashMap;
    }
    ...
    public String[] getTargetData(){
        return data[attributeCount-1];
    }

    public int getColumnFromLabel(String label){
        return labelToColumnHashMap.get(label);
    }
}
