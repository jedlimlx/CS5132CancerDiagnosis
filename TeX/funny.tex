...
\begin{itemize}
	...
	\item Using the same logic as before we can alsoc calculate the memory-complexity for training but we must account for the reduced datalength and multiple trees.
